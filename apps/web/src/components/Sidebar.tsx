...
export default function Sidebar() {
  ...
  const activeSpaceSidebarDisplayThreads = useMemo(
    () =>
      nonStudioSidebarDisplayThreads.filter((thread) => {
  ...
  const pinnedThreads = useMemo(
    () =>
      getPinnedThreadsForSidebar(
        isOnStudio ? studioSidebarDisplayThreads : activeSpaceSidebarDisplayThreads,
        pinnedThreadIds,
      ),
    [activeSpaceSidebarDisplayThreads, isOnStudio, pinnedThreadIds, studioSidebarDisplayThreads],
  );
  useEffect(() => {
  ...
  const currentProjectShortcutTargetId = useMemo(
    ...
    [activeSpaceId, focusedProjectId, ordinarySpaceProjects],
  );
