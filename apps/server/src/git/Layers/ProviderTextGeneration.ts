...
const makeProviderTextGeneration = (options?: ProviderTextGenerationLiveOptions) => Effect.gen(function* () {
  ...
  return {
    ...
    generateAutomationIntent: (input) =>
      run("generateAutomationIntent", input, (service) => service.generateAutomationIntent(input)),
