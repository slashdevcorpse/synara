...
describe("isLexicallyContainedPath", () => {
  it("accepts same-drive Windows descendants without accepting prefix siblings", () => {
    ...
    expect(
      isLexicallyContainedPath(workspaceRoot, "C:\\workspace\\src\\index.ts", win32),
    ).toBe(true);
    expect(
      isLexicallyContainedPath(workspaceRoot, "C:\\workspace-other\\index.ts", win32),
    ).toBe(false);
  });

  it("rejects Windows paths on a different drive", () => {
    expect(
      isLexicallyContainedPath("C:\\workspace", "D:\\workspace\\src\\index.ts", win32),
    ).toBe(false);
  });
